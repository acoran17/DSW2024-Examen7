    ...
    <div class="py-12">
            ...
            <div class="relative overflow-x-auto mt-8">
                ...
                <div class="mb-5">
                  ...
                  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    ...
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                    @error('body') border-red-600 @enderror" required>{{ $post->summary }}
                    </textarea>
                  @error('summary')
                  <div class="text-sm bg-red-200 px-3 py-1 rounded-lg">
                    {{ $message }}
                ...
                <div class="mb-5">
                  <label for="body"
                    ...
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                    @error('body') border-red-600 @enderror" required>{{ $post->body }}
                    </textarea>
                  @error('body')
                    <div class="text-sm bg-red-200 px-3 py-1 rounded-lg">
                      {{ $message }}
     ...
     value="{{ old('published_at', date('Y-m-d')) }}"
         ...
         dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                ...
                <button type="submit"
                  class="bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none
